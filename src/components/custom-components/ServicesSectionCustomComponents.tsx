        ...
        <Section bg="white">
            ...
            <div className="mx-auto mb-14 max-w-3xl text-center lg:mb-16">
                <p className="text-lg leading-relaxed text-slate-600">
                    Study Abroad (Pvt) Ltd provides comprehensive, end-to-end support with a focus on compliance and
                    student well-being. Since 2007, we have guided students through every milestone of their academic
                    transition.
                </p>
            </div>
